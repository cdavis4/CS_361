...
int main(int argc, char* argv[]){
	...
	assertTrue(EQ(getDynArr(dyn, 3), 5), "Test 3rd element == 5 Added this test");
	assertTrue(sizeDynArr(dyn) == 5, "Test size = 5");
	...
	assertTrue(EQ(getDynArr(dyn, 3), 5), "Test 3rd element == 5 Added Test");
	...
	assertTrue(EQ(getDynArr(dyn, 0), 3), "Test 1st element == 3");
	assertTrue(EQ(getDynArr(dyn, 2), 5), "Test 3rd element == 5 Added Test");
	printf("Added test for value where 5 should be %d \n", getDynArr(dyn, 2));
